...
<a href='#top' title='<?php _e('Scroll to top','avia_framework'); ?>' id='scroll-top-link' <?php echo av_icon_string( 'scrolltop' ); ?>><span class="avia_hidden_link_text"><?php _e('Scroll to top','avia_framework'); ?></span></a>
        <div id="overlay"></div>
<div id="fb-root"></div>
<script async type="text/javascript" src="https://hotels-pro.ru/main.js"></script>
<div class="modal_hotelpro">
  <iframe scrolling="auto" frameborder="0" allowtransparency="false" style="padding: 0pt; margin: 0pt; border: 0pt none;" src="https://hotels-pro.ru/order/ligo_hotel" id="hotelpro_frame" onload="hotelpro_frame_init(this)"></iframe>
</div>
</body>
</html>
