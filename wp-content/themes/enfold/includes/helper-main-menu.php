...
?>
		<div id='header_meta' class='container_wrap container_wrap_meta <?php echo avia_header_class_string(array('header_social', 'header_secondary_menu', 'header_phone_active'), 'av_'); ?>'>
			      ...
			      <div class='container'>
                    <div class="custom_logo_wrap">
                        <? // <div class="top_custom_logo">Ligo<span>Hotel</span></div>
                        //<div class="bot_custom_logo"><span>мини-отель</span> ЛигоХотел</div> ?>
                        <strong class="logo">
                            <a href="/">
                                <img height="100" width="300" src="/wp-content/uploads/2019/09/logo.png" alt="enfold-hotel">
                            </a>
                        </strong>
<? //<<<<<<< Updated upstream ?>
<?
...
//>>>>>>> Stashed changes ?>
			      ...
			      <?php
			        ...
			        ?><div class="top_right_block">
                          ...
                          <a href="/rooms/" class="top_bron_btn  avia-button  avia-icon_select-no avia-color-theme-color avia-size-large"><span class="avia_iconbox_title">Забронировать</span></a>

                          <div class="lang_wrap"><a href="">RU</a><span class="lang_divider">/</span><a href="">EN</a></div>
                      </div>
			      </div>
		</div>
